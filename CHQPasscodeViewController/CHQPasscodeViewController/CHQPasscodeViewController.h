...
typedef NS_ENUM(NSUInteger, CHQLockType)
{
    CHQLockTypeDigit = 0,
    CHQLockTypeCharacter,
    CHQLockTypeGesture,
    
    CHQLockTypeDefault = CHQLockTypeDigit
};
...
//these properties should not be here, but we need them to contact with the custom passcode views, you shall not operate them directly in your custom view, or the controller won't act normally.
...
@property (nonatomic, assign) BOOL        isUserSwitchingBetweenPasscodeModes;
